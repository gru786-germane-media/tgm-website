...
class BottomLoopText extends StatefulWidget {
  const BottomLoopText({super.key});

  @override
  State<BottomLoopText> createState() => _BottomLoopTextState();
}

class _BottomLoopTextState extends State<BottomLoopText>
