...
class MobileParticularBlog extends StatefulWidget {
  ...
  const MobileParticularBlog({super.key, required this.blogId});

  @override
  State<MobileParticularBlog> createState() => _MobileParticularBlogState();
}
...
class _MobileParticularBlogState extends State<MobileParticularBlog> {
  ...
  @override
  void didUpdateWidget(covariant MobileParticularBlog oldWidget) {
